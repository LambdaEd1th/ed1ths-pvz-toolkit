/* @ts-self-types="./rsb_patch_worker.d.ts" */

/**
 * @param {any} request
 * @returns {any}
 */
export function apply_rsb_patch(request) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.apply_rsb_patch(retptr, addHeapObject(request));
 ...
 * @returns {any}
 */
export function create_rsb_patch(request) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.create_rsb_patch(retptr, addHeapObject(request));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @returns {any}
 */
export function inspect_rsb_patch(request) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.inspect_rsb_patch(retptr, addHeapObject(request));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./rsb_patch_worker_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rsb_patch_worker_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
