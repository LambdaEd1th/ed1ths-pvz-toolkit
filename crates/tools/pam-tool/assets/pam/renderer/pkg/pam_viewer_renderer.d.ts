...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_9836: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1469: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1469_2: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1469_3: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9838: (a: number, b: number, c: number, d: number) => void;
