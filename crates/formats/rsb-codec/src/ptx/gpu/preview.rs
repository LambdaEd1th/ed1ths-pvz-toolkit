...
impl PtxPreviewRenderer {
    pub fn new(device: &wgpu::Device, target_format: wgpu::TextureFormat) -> Self {
        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("rsb-codec PTX preview shader"),
            source: wgpu::ShaderSource::Wgsl(include_str!("shaders/preview.wgsl").into()),
        });
        let layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            label: Some("rsb-codec PTX preview bind group layout"),
            entries: &[
        ...
        let pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: Some("rsb-codec PTX preview pipeline layout"),
        ...
        let alpha_pipeline = create_preview_pipeline(
            ...
            "rsb-codec PTX alpha preview pipeline",
        );
        let replace_pipeline = create_preview_pipeline(
            ...
            target_format,
            None,
            "rsb-codec PTX replace preview pipeline",
        );
        let sampler = device.create_sampler(&wgpu::SamplerDescriptor {
            label: Some("rsb-codec PTX preview sampler"),
    ...
    pub fn render(
        ...
        let uniform = self
            ...
            .create_buffer_init(&wgpu::util::BufferInitDescriptor {
                label: Some("rsb-codec PTX preview parameters"),
        ...
        let bind_group = self.device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("rsb-codec PTX preview bind group"),
            layout: &self.layout,
            entries: &[
                wgpu::BindGroupEntry {
                    binding: 0,
        ...
        let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
            label: Some("rsb-codec PTX preview pass"),
